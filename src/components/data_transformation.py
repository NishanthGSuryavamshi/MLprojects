...
class DataTranformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info('reading train & tet data completed')
            ...
            logging.info(
                'applying preprocessor initate obj on train n test dataset')
            ...
            logging.info("tranformed and concatenated train and test data")
